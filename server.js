...
// Enhanced imports untuk utils
const { logManager } = require('./utils/logs');
const EnhancedSessionManager = require('./utils/sessionManager');
...
resourceMonitor.startMonitoring(30000); // Every 30 seconds

// Setup session manager dengan resource monitor
